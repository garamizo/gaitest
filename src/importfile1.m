function imu9 = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   IMU9 = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   IMU9 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   imu9 = importfile1('imu9.csv', 2, 599);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/02/15 21:21:45
